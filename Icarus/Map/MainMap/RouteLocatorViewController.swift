...
//
//class RouteLocatorViewController: UIViewController, MGLMapViewDelegate, CLLocationManagerDelegate {
//    
...
//    var itemView : CustomCardView! // Keeps track of the current CustomItemView.
//    
...
//            itemView = CustomCardView(feature: feature, themeColor: themeColor, iconImage: iconImage)
...
//extension RouteLocatorViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
//    
//    func pageViewController(_ pageViewController: UIPageViewController, willTransitionTo pendingViewControllers: [UIViewController]) {
//        if let view = pendingViewControllers.first?.view as? CustomCardView {
...
//                itemView = nextVC.view as! CustomCardView!
//            }
//            return nextVC
//        }
//        return nil
